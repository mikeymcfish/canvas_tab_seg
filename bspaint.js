...
function initPaint(){ 
  ...
  var palette=$("#palette");
  let segPalette = [
    {"hex": "#787878", "name": "wall"},
    {"hex": "#B47878", "name": "building"},
    {"hex": "#06E6E6", "name": "sky"},
    {"hex": "#503232", "name": "floor"},
    {"hex": "#04C803", "name": "tree"},
    {"hex": "#787850", "name": "ceiling"},
    {"hex": "#8C8C8C", "name": "road"},
    {"hex": "#CC05FF", "name": "bed"},
    {"hex": "#E6E6E6", "name": "window"},
    {"hex": "#04FA07", "name": "grass"},
    {"hex": "#E005FF", "name": "cabinet"},
    {"hex": "#EBFF07", "name": "sidewalk"},
    {"hex": "#96053D", "name": "person,"},
    {"hex": "#787846", "name": "ground"},
    {"hex": "#08FF33", "name": "door"},
    {"hex": "#FF0652", "name": "table"},
    {"hex": "#8FFF8C", "name": "mountain"},
    {"hex": "#FF3307", "name": "curtain"},
    {"hex": "#CCFF04", "name": "plant"},
    {"hex": "#CC4603", "name": "chair"},
    {"hex": "#0066C8", "name": "car"},
    {"hex": "#3DE6FA", "name": "water"},
    {"hex": "#FF0633", "name": "painting"},
    {"hex": "#0B66FF", "name": "sofa"},
    {"hex": "#FF0747", "name": "shelf"},
    {"hex": "#FF09E0", "name": "house"},
    {"hex": "#0907E6", "name": "sea"},
    {"hex": "#DCDCDC", "name": "mirror"},
    {"hex": "#FF095C", "name": "rug"},
    {"hex": "#08FFD6", "name": "armchair"},
    {"hex": "#7009FF", "name": "field"},
    {"hex": "#07FFE0", "name": "seat"},
    {"hex": "#FFB806", "name": "fence"},
    {"hex": "#0AFF47", "name": "desk"},
    {"hex": "#FF290A", "name": "rock, stone"},
    {"hex": "#07FFFF", "name": "wardrobe"},
    {"hex": "#E0FF08", "name": "lamp"},
    {"hex": "#6608FF", "name": "bathtub"},
    {"hex": "#FF3D06", "name": "railing"},
    {"hex": "#FF7A08", "name": "pedestal"},
    {"hex": "#FFC207", "name": "cushion"},
    {"hex": "#00FF14", "name": "box"},
    {"hex": "#FF0829", "name": "column"},
    {"hex": "#FF0599", "name": "signboard"},
    {"hex": "#0633FF", "name": "dresser"},
    {"hex": "#EB0CFF", "name": "counter"},
    {"hex": "#FA0A0F", "name": "fireplace"},
    {"hex": "#1FFF00", "name": "grandstand"},
    {"hex": "#FF1F00", "name": "path"},
    {"hex": "#14FF00", "name": "refrigerator"},
    {"hex": "#A09614", "name": "sand"},
    {"hex": "#00A3FF", "name": "sink"},
    {"hex": "#8C8C8C", "name": "skyscraper"},
    {"hex": "#0000FF", "name": "showcase"},
    {"hex": "#00EBFF", "name": "pillow"},
    {"hex": "#FF4700", "name": "pool table"},
    {"hex": "#99FF00", "name": "runway"},
    {"hex": "#FFE000", "name": "stairs"},
    {"hex": "#FF5200", "name": "bridge"},
    {"hex": "#0BC8C8", "name": "river"},
    {"hex": "#00ADFF", "name": "screen door"},
    {"hex": "#1F00FF", "name": "staircase"},
    {"hex": "#003DFF", "name": "blind, screen"},
    {"hex": "#00FFF5", "name": "bookcase"},
    {"hex": "#00FF70", "name": "coffee table"},
    {"hex": "#FF0000", "name": "flower"},
    {"hex": "#00FF85", "name": "toilet"},
    {"hex": "#C2FF00", "name": "bench"},
    {"hex": "#FFA300", "name": "book"},
    {"hex": "#FF6600", "name": "hill"},
    {"hex": "#008FFF", "name": "countertop"},
    {"hex": "#00FF29", "name": "kitchen island"},
    {"hex": "#0052FF", "name": "palm tree"},
    {"hex": "#33FF00", "name": "stove"},
    {"hex": "#00FFAD", "name": "computer"},
    {"hex": "#0A00FF", "name": "swivel chair"},
    {"hex": "#FF5C00", "name": "arcade machine"},
    {"hex": "#00FF99", "name": "bar"},
    {"hex": "#ADFF00", "name": "boat"},
    {"hex": "#FF00F5", "name": "bus"},
    {"hex": "#FF00FF", "name": "shack, shanty"},
    {"hex": "#001FFF", "name": "chandelier"},
    {"hex": "#FFAD00", "name": "light"},
    {"hex": "#FF0066", "name": "towel"},
    {"hex": "#FFB8B8", "name": "tower"},
    {"hex": "#FF0014", "name": "truck"},
    {"hex": "#00FF52", "name": "airplane"},
    {"hex": "#0070FF", "name": "clothes"},
    {"hex": "#00FF3D", "name": "awning"},
    {"hex": "#FF00CC", "name": "booth, kiosk"},
    {"hex": "#000AFF", "name": "dirt, track"},
    {"hex": "#0047FF", "name": "streetlight"},
    {"hex": "#00FFC2", "name": "television"},
    {"hex": "#007AFF", "name": "bannister"},
    {"hex": "#00FF0A", "name": "bottle"},
    {"hex": "#FF7000", "name": "buffet counter"},
    {"hex": "#00FFA3", "name": "escalator"},
    {"hex": "#00C2FF", "name": "ground"},
    {"hex": "#FF9900", "name": "ottoman"},
    {"hex": "#3300FF", "name": "pole"},
    {"hex": "#8FFF00", "name": "poster"},
    {"hex": "#FFEB00", "name": "ship"},
    {"hex": "#5200FF", "name": "stage"},
    {"hex": "#A3FF00", "name": "van"},
    {"hex": "#46B8A0", "name": "bag"},
    {"hex": "#FF00A3", "name": "ball"},
    {"hex": "#FF0070", "name": "barrel"},
    {"hex": "#5CFF00", "name": "basket"},
    {"hex": "#00FF5C", "name": "canopy"},
    {"hex": "#8500FF", "name": "conveyer beltr"},
    {"hex": "#9900FF", "name": "cradle"},
    {"hex": "#FFCC00", "name": "food"},
    {"hex": "#08B8AA", "name": "fountain"},
    {"hex": "#A300FF", "name": "motorbike"},
    {"hex": "#47FF00", "name": "oven"},
    {"hex": "#FF001F", "name": "toy"},
    {"hex": "#00D6FF", "name": "stool"},
    {"hex": "#00B8FF", "name": "swimming pool"},
    {"hex": "#70E0FF", "name": "tent"},
    {"hex": "#B800FF", "name": "washing machine"},
    {"hex": "#00E0FF", "name": "waterfall"},
    {"hex": "#FF007A", "name": "animal"},
    {"hex": "#FFF500", "name": "bicycle"},
    {"hex": "#1400FF", "name": "blanket"},
    {"hex": "#D6FF00", "name": "dishwasher"},
    {"hex": "#0099FF", "name": "exhaust hood"},
    {"hex": "#0ABED4", "name": "lake"},
    {"hex": "#FF00EB", "name": "microwave"},
    {"hex": "#F500FF", "name": "flowerpot"},
    {"hex": "#00CCFF", "name": "projection screen"},
    {"hex": "#FFFF00", "name": "sculpture"},
    {"hex": "#FF008F", "name": "stair"},
    {"hex": "#00FFEB", "name": "storage tank"},
    {"hex": "#85FF00", "name": "trade name"},
    {"hex": "#2900FF", "name": "traffic light"},
    {"hex": "#AD00FF", "name": "trash"},
    {"hex": "#B8FF00", "name": "bulletin board"},
    {"hex": "#7A00FF", "name": "crt, screen"},
    {"hex": "#00F5FF", "name": "fan"},
    {"hex": "#005CFF", "name": "monitor"},
    {"hex": "#4700FF", "name": "pier"},
    {"hex": "#00FFB8", "name": "plate"},
    {"hex": "#FFD600", "name": "radiator"},
    {"hex": "#0029FF", "name": "sconce"},
    {"hex": "#0085FF", "name": "shower"},
    {"hex": "#29FF00", "name": "tray"},
    {"hex": "#00FFCC", "name": "vase"},
    {"hex": "#66FF00", "name": "clock"},
    {"hex": "#5C00FF", "name": "flag"},
    {"hex": "#19C2C2", "name": "drinking glass"}
];



  for (let i of segPalette) {
    const e=`<div class="paletteentry" style="background-color:${i.hex};"><div class="icon-holder" style="background-image:url('img/${i.name}.jpg')"></div>${i.name}</div>`;
      palette.append($(e).data("colour",i.hex));
    }
